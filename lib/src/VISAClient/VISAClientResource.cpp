...
VISAClientResource::VISAClientResource(LoggerIfc &logger,
...
auto VISAClientResource::write(std::string_view command) -> bool {
...
auto VISAClientResource::query(std::string_view command) -> ReadResult {
