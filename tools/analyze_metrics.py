...
class MetricsAnalyzer:
    ...
    def _print_platform_summary(self, platform: str, metrics: List[dict]):
        ...
        print(f"    Total:   {cpu_user_ms + cpu_sys_ms}ms (user: {cpu_user_ms}ms, sys: {cpu_sys_ms}ms)")
    ...
    def print_comparison_table(self):
        ...
        # Header
        print(f"{'Platform':<25} {'Samples':>10} {'Duration':>10} {'RSS Avg':>12} {'RSS Max':>12} {'CPU Avg':>10}")
        print("-" * 100)
        ...
        for platform, metrics in sorted(self.data.items()):
            ...
            print(f"{platform:<25} {len(metrics):>10} {duration_s:>9.1f}s {statistics.mean(rss_values):>11.2f}MB "
